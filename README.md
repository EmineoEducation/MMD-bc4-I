# PAC BC4-I — Développer une stratégie de marketing digital et e-commerce au service d'un commanditaire

Manager en stratégie et développement de projet digital

## Déploiement
1. Créer le repo `lumio-bc4-i` avec **tout le contenu de ce ZIP**.
